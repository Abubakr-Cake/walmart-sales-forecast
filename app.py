...
model_df = df.drop(columns=["Date", "IsHoliday"])
...
# Display Actual vs Predicted and Error side-by-side
...
# Filter data for time series view
df["Date"] = pd.to_datetime(df["Date"])
...
# Future sales prediction inputs
...
# Always show prediction result section
...
# Feature Importance (Interactive, Inverted)
